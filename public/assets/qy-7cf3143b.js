(() => {
  // engine/rails_design/app/javascripts/weixin_script/index.js
...
location: ${location.href}`);
  ...
  // engine/rails_design/app/javascripts/wxwork_script/index.js
...
%o`, message, error2, detail);
  ...
  var mini_program_default = class extends Controller {
    ...
    connect() {
      const weixin_script2 = document.getElementById("weixin_script");
      if (window.__wxjs_environment === "miniprogram") {
        if (this.directValue) {
          if (typeof wx === "undefined") {
            weixin_script2.addEventListener("load", () => {
              this.navTo();
            });
          } else {
            this.navTo();
  ...
  // engine/rails_design/app/javascripts/stimulus_wx/mp-message.js
  var mp_message_default = class extends Controller {
    static values = {
      data: Object
    };
    connect() {
  ...
  application.register("mp-message", mp_message_default);
  ...
  // engine/rails_design/app/javascripts/stimulus_qy/share-moment.js
  var share_moment_default = class extends Controller {
    static values = {
      text: String,
      images: Array
    };
  ...
  // engine/rails_design/app/javascripts/stimulus_qy/open-data.js
  var open_data_default = class extends Controller {
    static targets = ["tag"];
    static values = {
      url: String
    };
  ...
  // engine/rails_design/app/javascripts/stimulus_qy/index.js
  application.register("share-moment", share_moment_default);
  application.register("open-data", open_data_default);
})();
